...
// in bojang/test/screens/settings_screen_test.dart.
...
class MockApiService extends _i1.Mock implements _i5.ApiService {
  ...
  @override
  _i3.Future<List<Map<String, dynamic>>?> getMemoryMatchCards({
    required String? levelId,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getMemoryMatchCards, [], {#levelId: levelId}),
            returnValue: _i3.Future<List<Map<String, dynamic>>?>.value(),
          )
          as _i3.Future<List<Map<String, dynamic>>?>);
